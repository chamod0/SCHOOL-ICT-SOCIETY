        ...
        <div class="col-sm-12 center">
                      ...
                      <div class="card bg-success card-hover scrolling">
                          <div class="card-body text-center p-0">
                              ...
                              <h2 class="text-white font-size-32 pt-1 pt-lg-5 pb-2 pb-lg-6 mb-0 font-dosis">{{ $mentor->Name}}</h2>
                          ...
                          <div class="card-img text-center">
                            <ul class="list-unstyled mb-0 d-flex align-items-center h-100 justify-content-center">
                              <li class="mr-2">
                                <a href="{{ $mentor->Facebook}}" class="text-white">
                                                    <i class="fa fa-facebook" aria-hidden="true"></i>
                                                </a>
                                              
                              </li>
                              <li class="mr-2">
                                <a href="{{ $mentor->twitter}}" class="text-white">
                                                    <i class="fa fa-twitter" aria-hidden="true"></i>
                                                </a>
                              </li>
                              <li class="mr-2">
                                <a href="{{ $mentor->Email}}" class="text-white">
                                                    <i class="fa fa-google-plus" aria-hidden="true"></i>
                                                </a>
                              </li>
                              <li class="mr-2">
                                <a href="{{ $mentor->Linkin}}" class="text-white">
        ...
        <div class="row">
          <div class="col-sm-4 col-xs-12">
            <div class="image mb-5 mb-md-0">
              <img class="w-100 rounded" src="{{ URL('assets/img/mentor/'.$mentor->img)}}" alt="team-1.jpg">
            </div>
          </div>
          ...
          <div class="col-sm-8 col-xs-12">
            ...
            <p class="text-muted mb-5">{{ $mentor->About}}</p>
            ...
            <a > Tel No : {{ $mentor->Tel}}</a><br>
            <a > Email : {{ $mentor->Email}}</a>
            <div class="mb-7">
