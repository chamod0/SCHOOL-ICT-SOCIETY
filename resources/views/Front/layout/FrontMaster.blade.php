                      ...
                      <ul class="bg-white list-unstyled">
                        ...
                        <li>
                          ...
                          <div class="cart-button d-flex justify-content-between">
                            <button type="button" class="btn btn-danger text-uppercase px-4 shadow-sm mr-3" onclick="if (!window.__cfRLUnblockHandlers) return false; location.href='product-checkout-step-1.html';" data-cf-modified-3160fe0de5fefd8beef53e99-="">Checkout</button>
                            <button type="button" class="btn btn-danger text-uppercase px-4 shadow-sm" onclick="if (!window.__cfRLUnblockHandlers) return false; location.href='product-cart.html';" data-cf-modified-3160fe0de5fefd8beef53e99-="">View
                              Cart</button>
                          </div>
                        </li>
                      </ul>
          ...
          <ul class="navbar-nav ml-lg-auto">
            ...
            <li class="nav-item dropdown bg-danger">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item " href="about-us.html">What is School ICT Society</a>
                </li>
                
                <li>
                  <a class="dropdown-item " href="testimonial.html">How to Become a Member</a>
                </li>
